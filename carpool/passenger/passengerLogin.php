...
// Query database to check if exists
      $query = "SELECT password, email, name FROM cs2102.customer WHERE email=$1";
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <form name="passengerLogin" method="post" class="form-signin">
              <h2 class="form-signin-heading text-center">Passenger Login</h2>
