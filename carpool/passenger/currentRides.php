...
<?php
  ...
  $query = "SELECT o.offerid, d.name, d.gender, d.mobileno, o.startdate, r.starttime, r.startloc, r.endloc FROM cs2102.Driver d INNER JOIN cs2102.Ride r ON d.carplateno = r.carplateno 
    INNER JOIN cs2102.Customer c ON c.email = r.email 
    INNER JOIN cs2102.RideOffer o ON o.carplateno = d.carplateno AND o.offerid = r.offerid
    WHERE c.email=$1 AND o.startdate >= current_date 
    ORDER BY o.startdate, r.starttime";
